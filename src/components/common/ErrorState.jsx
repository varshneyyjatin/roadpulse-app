// Error Icons based on error type
const ErrorIcons = {
  network: (
...
const ErrorState = ({ 
  ...
  message = "We encountered an issue while fetching the data. Please try again.", 
  onRetry,
  showRetry = true,
  icon = 'error', // network, server, timeout, auth, forbidden, notfound, validation, error
  statusCode = null
}) => {
  return (
      ...
      <div className="max-w-md mx-auto text-center">
        ...
        <div className="w-16 h-16 mx-auto mb-6 bg-red-50 dark:bg-red-900/20 rounded-full flex items-center justify-center">
          <div className="text-red-600 dark:text-red-400">
            {ErrorIcons[icon] || ErrorIcons.error}
          </div>
        </div>
